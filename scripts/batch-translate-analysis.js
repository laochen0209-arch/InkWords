/**
 * @file batch-translate-analysis.js
 * @description 批量翻译题目解析 - JavaScript 版本（无需 ts-node）
 * @author InkWords Team
 * @date 2026-02-08
 * 
 * 使用方法:
 * node scripts/batch-translate-analysis.js
 */
...
// 处理 mock_exams 表
const processMockExams = async (supabase) => {
...
const processQuestions = async (supabase) => {
